                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="" onerror="this.src='{{asset("/assets/admin/img/aspect-1.png")}}'" class="img__aspect-1 min-w-187px max-w-187px" alt="">
                                            </div>
                                    ...
                                    {{-- <div class="d-flex flex-column">
                                        ...
                                        <label class="upload-img-4 m-0 d-block my-auto">
                                            <div class="img">
                                                <img src="" onerror="this.src='{{asset("/assets/admin/img/aspect-3-1.png")}}'" class="vertical-img min-w-187px max-w-187px" alt="">
                                            </div>
