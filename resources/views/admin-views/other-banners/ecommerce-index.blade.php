                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="__upload-img aspect-235-375 m-auto d-block position-relative">
                                        <div class="img">
                                            <img src="{{asset('storage/app/public/promotional_banner')}}/{{$best_reviewed_section_banner?->value}}" onerror='this.src="{{asset('/assets/admin/img/upload-placeholder.png')}}"' alt="">
                                        </div>
                                        <div>
                    ...
                    <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="__upload-img aspect-235-375 m-auto d-block position-relative">
                                        <div class="img">
                                            <img src="{{asset('storage/app/public/promotional_banner')}}/{{$new_arrival_section_banner?->value}}" onerror='this.src="{{asset('/assets/admin/img/upload-placeholder.png')}}"' alt="">
                                        </div>
                                        <div class="">
                                        <input type="file" name="image"  hidden>
                                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="__upload-img aspect-5-1 m-auto d-block">
                                        <div class="img">
                                            <img src="{{asset('storage/app/public/promotional_banner')}}/{{$bottom_section_banner?->value}}" onerror='this.src="{{asset('/assets/admin/img/upload-placeholder.png')}}"' alt="">
                                        </div>
