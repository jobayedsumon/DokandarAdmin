                                ...
                                <div class="col-sm-6">
                                    <div class="ml-5">
                                        ...
                                        <label class="upload-img-3 m-0">
                                            <div class="img">
                                                <img src="{{asset('storage/app/public/why_choose')}}/{{ $banner['image']??'' }}" onerror='this.src="{{asset('/assets/admin/img/aspect-1.png')}}"' alt="" class="img__aspect-1 min-w-187px max-w-187px">
                                            </div>
