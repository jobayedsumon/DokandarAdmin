                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            <img src="{{asset('storage/app/public/banner')}}/{{$banner['image']}}" id="viewer" onerror='this.src="{{asset('/assets/admin/img/upload-4.png')}}"' class="vertical-img mw-100 vertical" alt="">
                                        </div>
